...
- **Obsidian project notes** — at session start, read `02-Projets/[project-name]/` in Obsidian vault via MCP. At session end, update with decisions, bugs, next steps. Notes are the project memory system.
